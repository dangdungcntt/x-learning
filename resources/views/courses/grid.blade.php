					...
					<div class="col-sm-6 col-md-4">
						<div class="course-post">
							...
							<div class="info">
								...
								<div class="expert">
									<span>By </span> Michael Windzor</div>
							</div>
							<div class="product-footer">
								<div class="comment-box">
									<div class="box">
										<i class="fa fa-users"></i>35 Enrolled</div>
								</div>
								<div class="rating">
					...
					<div class="col-sm-6 col-md-4">
						<div class="course-post">
							...
							<div class="info">
								...
								<div class="expert">
									<span>By </span> text of the printing</div>
							</div>
							<div class="product-footer">
								<div class="comment-box">
									<div class="box">
					...
					<div class="col-sm-6 col-md-4">
						<div class="course-post">
							...
							<div class="info">
								...
								<div class="expert">
									<span>By </span> unknown printer</div>
							</div>
							<div class="product-footer">
								<div class="comment-box">
									<div class="box">
