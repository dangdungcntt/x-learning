            ...
            <div class="row">
                ...
                <form method="POST" action="{{ route('courses.store') }}">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="input-box">
                            <label>Name</label>
                            <input type="text" class="{{ $errors->has('name') ? ' has-error' : '' }}"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-box">
                                    <label>Price ($)</label>
                                    <input type="text" class="{{ $errors->has('price') ? ' has-error' : '' }}"
                            ...
                            <div class="col-sm-6">
                                <div class="input-box">
                                    ...
                                    <input type="number" class="{{ $errors->has('max_students') ? ' has-error' : '' }}"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-box">
                                    ...
                                    <input type="date" class="{{ $errors->has('start_at') ? ' has-error' : '' }}"
                            ...
                            <div class="col-sm-6">
                                <div class="input-box">
                                    ...
                                    <input type="date" class="{{ $errors->has('end_at') ? ' has-error' : '' }}"
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" class="{{ $errors->has('description') ? ' has-error' : '' }}"
                        ...
                        <div class="input-box">
                            <label>Details</label>
                            <textarea class="{{ $errors->has('details') ? ' has-error' : '' }}"
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="input-box">
                            ...
                            <label>Hình ảnh <span class="require-color">*</span></label>
                            <label class="btn btn-default" for="courseImg"><i class="fa fa-folder-open"
                                                                              aria-hidden="true"></i> Chọn ảnh</label>
                            <input type="file" name="image" id="courseImg" placeholder="Hình ảnh" required="required"
                                   style="display: none"/>
