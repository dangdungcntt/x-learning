                ...
                <div class="col-md-4 col-sm-6">
                    <div class="course-box">
                        ...
                        <div class="comment-row">
                            ...
                            <div class="box">
                                <i class="fa fa-users"></i>35 Student
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="course-box">
                        <div class="img">
                            ...
                            <div class="course-info">
                                <div class="date">
                                    <i class="fa fa-calendar"></i>17-09-2016
                                </div>
                                <div class="date">
                                    <i class="fa fa-clock-o"></i>1 Days
                                </div>
                                <div class="favorite">
                                    <a href="#">
                        ...
                        <div class="comment-row">
                            ...
                            <div class="box">
                                <i class="fa fa-users"></i>30 Student
                            </div>
                            <div class="enroll-btn">
                                <a href="#" class="btn">Enroll</a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="feedback-slider">
                <div class="item">
                    ...
                    <p>
                        <i class="fa fa-quote-left"></i> Lorem Ipsum is simply dummy text of the printing and
        ...
        <div class="member-slider">
            <div class="item">
                <div class="member-info">
                    ...
                    <p>It was popularised in the 1960s with the release of recently with desktop publishing software
