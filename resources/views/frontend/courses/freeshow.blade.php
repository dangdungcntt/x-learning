					...
					<div class="reviews-view">
						...
						<div class="reviews-slide">
							...
							<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some
								...
								a passage of Lorem Ipsum, you </p>
						</div>
						<div class="reviews-slide">
							<div class="img">
								<img src="images/user-img/student-img1.png" alt="">
			...
			<div class="col-sm-4 col-md-3">
				<div class="right-slide">
					...
					<div class="course-details-list">
						<ul>
							<li>
								<i class="fa fa-user-secret"></i>Rebecca Smith</li>
							<li>
								<i class="fa fa-file"></i>17 Lessons</li>
							<li>
								<i class="fa fa-exclamation"></i>7 Quizzes</li>
							<li>
								<i class="fa fa-file-text-o"></i>13 Documents</li>
							<li>
								<i class="fa fa-video-camera"></i>9 vedio</li>
							<li>
								<i class="fa fa-mortar-board"></i>1719 Students</li>
							<li>
								<i class="fa fa-calendar"></i>16-09-2016 - 15-08-2018 </li>
						</ul>
						<div class="price-info">
							<span>Price: </span>Free</div>
						<div class="btn-block">
