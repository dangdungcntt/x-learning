...
<div class="wrapper">
    ...
    overflow: hidden;">
        ...
        <div class="" id="main" style="margin-left: 320px; padding: 0">
            ...
            <div class="player-area" style="background: #0f1622; height: calc(100vh - 58px)">
                <video autoplay="" controls="" crossorigin="" id="player" style="height: 100%"></video>
            </div>
        </div>
        <!-- /main -->
    </div>
    <div class="chat-box" title="Chat box">
        ...
        <i class="far fa-comment-alt fa-2x" style="    margin-left: 10px;
    margin-top: 10px;
    color: #fff;"></i>
    </div>
</div>
